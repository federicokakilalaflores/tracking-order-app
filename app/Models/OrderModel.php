...
class OrderModel extends Model
{
    ...
    public static function saveOrder($id = null){
        ...
        $order->fldOrderQuantity = serialize(Request::get('quantity'));
        $order->fldOrderDateReceived = serialize(Request::get('date_received')); 
        $order->fldOrderCustomerID = Request::get('customer_id');
        $order->fldOrderProductID = serialize(Request::get('product_id'));
        ...
        $order->fldOrderCustomPrice = serialize(Request::get('custom_price')) ?  serialize(Request::get('custom_price')): NULL;     
        $order->save();  
